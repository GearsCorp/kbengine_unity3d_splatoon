...
public class EasyJoystick : MonoBehaviour {
    ...
    #endregion
    //public static Rect constAreaRect = new Rect();

    
    public static Rect GetTouchRect()
    {
        //constAreaRect.x = areaRect.x;
        //constAreaRect.y = areaRect.y;
        //constAreaRect.width = areaRect.width;
        //constAreaRect.height = areaRect.height;
        return areaRect;
    }
