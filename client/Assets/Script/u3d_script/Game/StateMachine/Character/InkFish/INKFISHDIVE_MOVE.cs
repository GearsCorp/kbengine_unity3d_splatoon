...
public class INKFISHDIVE_MOVE : SMState{
    ...
    public INKFISHDIVE_MOVE(string name, GameObject go) :
        base(name, go)
    {
    ...
    public override void OnUpdate()
    {
        ...
        _characterMotionObj.SurfaceMode = CharacterMotion.E_SurfaceMode.SM_ON_SURFACE;   //跨面模式
