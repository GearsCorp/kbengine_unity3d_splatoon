...
using KBEngine;
using UnityEngine;
public class HUMAN_MOVE : SMState
{
    ...
    public override void OnUpdate()
    {
        ...
        _characterMotionObj.SurfaceMode = CharacterMotion.E_SurfaceMode.SM_ON_GROUND;   //非跨面模式
        _characterMotionObj.ForWardMode = CharacterMotion.E_ForWardMode.FM_ON_FORWARD;  //贴面时当前forward的朝向模式
