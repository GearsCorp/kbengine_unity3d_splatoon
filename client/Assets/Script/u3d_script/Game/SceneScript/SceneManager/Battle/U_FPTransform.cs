...
namespace KBEngine
{
    ...
    **/
    [ExecuteInEditMode]
    public class U_FPTransform : MonoBehaviour
    {
        ...
        **/
        public FPQuaternion rotation
        {
            get
            {
             //   Debug.Log("rrrrrrrrrrrrrrrrrrrrr::" + _rotation.ToQuaternion() + " .,," + _rotation.id);
                if (tsCollider != null && tsCollider.Body != null)
                {
            ...
            set
            {
           //     Debug.Log("ddddddddddddddddddddddddddddddddddddddddddddddd::" + value.ToQuaternion());
                _rotation = value;
        ...
        **/
        ...
        {
            transform.forward = this.forward.ToVector();
        }
        public void UpdateFpRotation(FPQuaternion fpRotation)
        {
            this.rotation = fpRotation;
        }
        ...
        {
            transform.position = this.position.ToVector();
        }
