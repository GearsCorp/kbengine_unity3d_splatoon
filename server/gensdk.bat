...
cd %curpath%
start %KBE_BIN_PATH%/kbcmd.exe --clientsdk=unity --outpath=D:\work\unity\unity_work\code\newDemo__InkPaintDemo\InkPaintDemo_New\Assets\Plugins\kbengine_unity3d_plugins
